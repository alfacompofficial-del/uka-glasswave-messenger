  ...
  head: () => ({
    meta: [
      { title: "UKA Messenger — Cyberpunk-мессенджер с AI" },
      {
        name: "description",
        content:
          "Стильный, защищённый мессенджер с AI-переводом и умным конвертером кириллицы/латиницы.",
      },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="relative z-10 mx-auto flex max-w-6xl items-center justify-between px-6 py-5">
        ...
        <Link
          to="/auth"
          className="glass rounded-full px-5 py-2 text-sm font-medium hover:neon-ring transition"
        >
          Войти
        </Link>
      </nav>
      ...
      <section className="relative z-10 mx-auto max-w-6xl px-6 pt-16 pb-24 text-center">
        ...
        <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground">
          UKA Messenger — киберпанк-эстетика, мгновенные сообщения, встроенный AI-переводчик и умный
          конвертер кириллицы/латиницы.
        </p>
        <div className="mt-10 flex flex-wrap justify-center gap-4">
          ...
          <a
            href="#features"
            className="glass-strong rounded-full px-8 py-3.5 text-base font-medium hover:neon-ring transition"
          >
            Возможности
          </a>
        </div>
      ...
      <section id="features" className="relative z-10 mx-auto max-w-6xl px-6 pb-24">
        ...
        <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-3">
          <Feature
            icon={Shield}
            title="Безопасность"
            text="Сообщения видят только участники чата. Даже администратор не имеет доступа к личным перепискам."
          />
          <Feature
            icon={Sparkles}
            title="Стиль"
            text="Glassmorphism + неоновые акценты. Уникальный дизайн, выделяющий UKA среди десятков клонов."
          />
          <Feature
            icon={Languages}
            title="AI-переводчик"
            text="Live Translate входящих сообщений: пишите на узбекском, читайте на русском."
          />
          <Feature
            icon={Zap}
            title="Умный конвертер"
            text="Кириллица ⇄ латиница одним кликом, прямо в поле ввода — без бота."
          />
          <Feature
            icon={MessageCircle}
            title="Реальное время"
            text="WebSocket-сообщения, моментальная доставка через Realtime-канал."
          />
          <Feature
            icon={Lock}
            title="Роли"
            text="Гибкая система прав: пользователи и администраторы со своей зоной ответственности."
          />
        </div>
      </section>
