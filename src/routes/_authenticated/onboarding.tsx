      ...
      <div className="w-full max-w-lg">
        <div className="text-center mb-6">
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Эти данные нужны, чтобы друзья смогли вас найти
          </p>
        </div>
        ...
        <form onSubmit={submit} className="glass-strong rounded-2xl p-6 space-y-4">
          ...
          <div>
            ...
            <div className="mt-1.5 flex">
              <span className="inline-flex items-center px-3 rounded-l-md bg-muted text-muted-foreground border border-r-0 border-border">
                @
              </span>
              <Input
                value={username}
